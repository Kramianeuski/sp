...
<form method="post" class="card form-card">
    ...
    <div class="field">
        ...
        <input id="category-slug" type="text" name="slug" value="<?= htmlspecialchars($category['slug'], ENT_QUOTES) ?>">
    </div>
    <div class="field">
        <label for="category-status"><?= htmlspecialchars(t('admin.status', 'ru'), ENT_QUOTES) ?></label>
        <select id="category-status" name="status">
            <option value="published" <?= ($category['status'] ?? '') === 'published' ? 'selected' : '' ?>><?= htmlspecialchars(t('admin.status_published', 'ru'), ENT_QUOTES) ?></option>
            <option value="archived" <?= ($category['status'] ?? '') === 'archived' ? 'selected' : '' ?>><?= htmlspecialchars(t('admin.status_archived', 'ru'), ENT_QUOTES) ?></option>
        </select>
    </div>
