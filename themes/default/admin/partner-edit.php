...
<form method="post" class="card form-card" enctype="multipart/form-data">
    ...
    <div class="field">
        ...
        <select id="partner-type" name="type">
            <option value="official_distributor" <?= ($partner['type'] ?? '') === 'official_distributor' ? 'selected' : '' ?>><?= htmlspecialchars(t('partner.type.official_distributor', 'ru'), ENT_QUOTES) ?></option>
            <option value="marketplace" <?= ($partner['type'] ?? '') === 'marketplace' ? 'selected' : '' ?>><?= htmlspecialchars(t('partner.type.marketplace', 'ru'), ENT_QUOTES) ?></option>
        </select>
    </div>
    <div class="field">
