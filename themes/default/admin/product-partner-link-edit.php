...
<div class="page-header">
    <h1><?= htmlspecialchars(t('admin.partner_links_edit', 'ru'), ENT_QUOTES) ?></h1>
...
<form method="post" class="card form-card">
    ...
    <div class="field">
        ...
        <select name="product_id">
            <?php foreach ($products as $product) : ?>
                <option value="<?= htmlspecialchars((string) $product['id'], ENT_QUOTES) ?>" <?= (string) $product['id'] === (string) $link['product_id'] ? 'selected' : '' ?>>
    ...
    <div class="field">
        ...
        <select name="partner_id">
            <?php foreach ($partners as $partner) : ?>
                <option value="<?= htmlspecialchars((string) $partner['id'], ENT_QUOTES) ?>" <?= (string) $partner['id'] === (string) $link['partner_id'] ? 'selected' : '' ?>>
    ...
    <div class="field">
        ...
        <input type="text" name="product_url" value="<?= htmlspecialchars($link['product_url'], ENT_QUOTES) ?>">
    </div>
    <label class="checkbox-field">
        <input type="checkbox" name="is_active" value="1" <?= !empty($link['is_active']) ? 'checked' : '' ?>>
