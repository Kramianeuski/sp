        ...
        <div class="product-hero-grid">
            ...
            <div class="product-summary">
                ...
                <?php if (!empty($product['sku'])) : ?>
                    <div class="product-meta"><?= htmlspecialchars(t('product.sku', $language), ENT_QUOTES) ?>: <?= htmlspecialchars($product['sku'], ENT_QUOTES) ?></div>
                <?php endif; ?>
            ...
            <aside class="product-info-panel">
                        ...
                        <ul class="sidebar-list">
                            <?php foreach ($partners as $partner) : ?>
                                <li>
                                    ...
                                    <span><?= htmlspecialchars(t('partner.type.' . $partner['type'], $language), ENT_QUOTES) ?></span>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                ...
                <?php if ($documentItems) : ?>
                    <div class="info-card">
                        ...
                        <ul class="sidebar-list">
                            <?php foreach (array_slice($documentItems, 0, 4) as $doc) : ?>
                                <li>
...
<section class="content-with-sidebar">
    <div class="container content-grid">
        <div class="content-main">
            <section class="content-block" id="purpose">
                <h2><?= htmlspecialchars(t('product.purpose_title', $language), ENT_QUOTES) ?></h2>
            ...
            <section class="content-block">
                <h2><?= htmlspecialchars(t('product.kit_title', $language), ENT_QUOTES) ?></h2>
                <p><?= htmlspecialchars(t('product.kit_text', $language), ENT_QUOTES) ?></p>
            </section>
            <?php if ($documentItems) : ?>
                <section class="documents content-block" id="documents">
            ...
            <section class="content-block" id="partners">
                ...
                <?php else : ?>
                    <p><?= htmlspecialchars(t('partners.empty', $language), ENT_QUOTES) ?></p>
                <?php endif; ?>
            </section>
            <?php if ($faqItems) : ?>
